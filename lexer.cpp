...
enum class State {INIT, INT, WORD, STRING, DECIMAL, FRACTION, ERROR};
        ...
        switch (state) {
            ...
            case State::DECIMAL:
                if (c >= '0' && c <= '9') {
                    ...
                    std::cout << "Digit expected following a decimal point" << "\n";
                    lexeme = "";
                    state = State::INIT;
                    index--;
                }
            ...
            case State::FRACTION:
                if (c >= '0' && c <= '9') {
                    ...
                    std::cout << "Decimal count cannot exceed 1 decimal" << "\n";
                    lexeme = "";
                    state = State::ERROR;
                }
                else {
